...
export default function AdminGuideReservationUpdate(props) {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/guidereservation/${id}`).then((res) => {
            setData(res.data);
    ...
    function updateGuideReservation(event) {
        ...
        axios.put(`http://localhost:8080/guidereservation/update/${id}`, data).then(() => {
    ...
    return (
        <div className="container">
                        ...
                        <form onSubmit={updateGuideReservation}>
